...
- set center frequency to one `4635 kHz` range
- select `USB` (Upper Side Band) decoding mode
- narrow the filter around the carrier
...
- [The Buzzer (ZhUOZ MDZhB UZB76)](<https://www.sigidwiki.com/wiki/The_Buzzer_(ZhUOZ_MDZhB_UZB76)>)
- [UVB-76 (The Buzzer)](<https://hfunderground.com/wiki/index.php/UVB-76_(The_Buzzer)>)
